...
AThirdPersonMPProjectile::AThirdPersonMPProjectile()
{
	...
	// Definition for the Mesh that will serve as visual representation.
	static ConstructorHelpers::FObjectFinder<UStaticMesh> DefaultMesh(TEXT("/MMORPG/StarterContent/Shapes/Shape_Sphere.Shape_Sphere"));
